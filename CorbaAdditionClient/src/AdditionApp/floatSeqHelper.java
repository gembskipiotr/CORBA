...
/**
* AdditionApp/floatSeqHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Addition.idl
* wtorek, 21 stycznia 2020 22:39:18 CET
*/

abstract public class floatSeqHelper
{
  private static String  _id = "IDL:AdditionApp/floatSeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (AdditionApp.floatSeqHelper.id (), "floatSeq", __typeCode);
    }
    return __typeCode;
  }
