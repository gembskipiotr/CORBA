 ...
 implements AdditionApp.AdditionOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("b_sort", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // AdditionApp/Addition/b_sort
       {
         String tab = in.read_string ();
         float $result[] = null;
         $result = this.b_sort (tab);
         out = $rh.createReply();
         AdditionApp.floatSeqHelper.write (out, $result);
         break;
       }
